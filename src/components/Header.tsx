  ...
  return (
    <header className="relative z-30 flex items-center justify-between px-4 py-3 sm:px-8 sm:py-4 border-b border-zinc-800/80 bg-[#0b0c16]/90 backdrop-blur-md select-none">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Google Sign In Direct Button if Guest */}
        {!userProfile.isGoogleUser && onOpenGoogleSignIn && (
          <button
            type="button"
            onClick={() => {
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white hover:bg-zinc-100 text-zinc-900 text-xs font-bold shadow-md transition-all cursor-pointer active:scale-95"
